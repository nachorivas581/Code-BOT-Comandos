...
permited=$(curl -sSL "${link}/ChumoGH/VPSbot/main/TeleBotGen/Control/Control-Bot")
 ...
 ### INTALAR VERCION DE SCRIPT
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/nachorivas581/Code-BOT-Comandos/main/v-new.log?token=GHSAT0AAAAAACDESZ52T7ZX7FPU7NGZ46H6ZFEVWPA")
...
wget -q --no-check-certificate -O $HOME/files.tar https://raw.githubusercontent.com/nachorivas581/Code-BOT-Comandos/main/files.tar
